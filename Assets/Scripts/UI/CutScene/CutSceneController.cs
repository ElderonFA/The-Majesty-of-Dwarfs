...
public class CutSceneController : MonoBehaviour
{
    ...
    {
        var startPosTop = topBorder.localPosition.y;
        var endPosTop = startPosTop - topBorder.rect.height;
        
        var startPosBottom = bottomBorder.localPosition.y;
        while (topBorder.localPosition.y > endPosTop)
        {
            startPosTop -= Time.deltaTime * 200f;
            startPosBottom += Time.deltaTime * 200f;
            topBorder.localPosition = new Vector2(topBorder.localPosition.x, startPosTop);
            bottomBorder.localPosition = new Vector2(bottomBorder.localPosition.x, startPosBottom);
            yield return null;
        }
    }
